<template>
    <div class="container mx-auto px-2">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            <div
                class="bg-red-500 hover:bg-gradient-to-r from-red-600 to-pink-500"
            ></div>
            <div class="bg-red-500 hover:bg-red-200">02</div>
            <div class="bg-red-500 hover:bg-red-200">03</div>
            <div class="bg-red-500 hover:bg-red-200">04</div>
            <div class="bg-red-500 hover:bg-red-200">05</div>
            <div class="bg-red-500 hover:bg-red-200">06</div>
            <div class="bg-red-500 hover:bg-red-200">07</div>
            <div class="bg-red-500 hover:bg-red-200">07</div>
        </div>
        <div class="grid grid-cols-3 gap-4 place-items-stretch h-56 mt-5">
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">
                <font-awesome-icon icon="fa fa-plus" color="green" size="md" />
            </div>
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">02</div>
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">03</div>
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">04</div>
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">05</div>
            <div class="ring-2 ring-black/5 shadow-lg rounded-sm">06</div>
        </div>
        <div class="sm:columns-1 md:columns-2 lg:columns-3 mt-5">
            <img
                class="w-full aspect-video mb-2 transition duration-300 hover:rotate-45"
            ...
            />
            <img
                class="w-full aspect-square mb-2 transition duration-300 hover:rotate-45"
                src="https://images.unsplash.com/photo-1463288889890-a56b2853c40f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3132&q=80"
            />
            <img
                class="w-full aspect-video mb-2 transition duration-300 hover:rotate-45"
        ...
        <div class="relative rounded-xl overflow-auto p-8">
            <div
                class="overflow-visible relative max-w-xl mx-auto bg-white shadow-lg ring-1 ring-black/5 rounded-xl flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5"
            >
                <img
        ...
        <div
            class="pointer-events-auto h-6 w-10 rounded-full p-1 ring-1 ring-inset transition duration-200 ease-in-out"
            :class="
                toggle
        ...
        <div class="relative z-10 p-4">
            ...
            ></div>
            <div
                class="absolute bottom-full left-40 -mb-px flex h-8 items-end overflow-hidden"
            >
        ...
        <div class="isolate relative bg-white py-24 px-6 sm:py-32 lg:px-8">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            >
                                ...
                                <svg
                                    class="pointer-events-none absolute top-0 right-1 h-full w-5 text-gray-400"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                                >
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="relative mt-2.5">
                            ...
                            >
                                ...
                                <svg
                                    class="pointer-events-none absolute top-0 right-2 h-full w-5 text-gray-400"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                                >
